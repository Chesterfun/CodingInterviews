...
public:
    TreeNode* reConstructBinaryTree(vector<int> pre,vector<int> in) {
        ...
        while (rootIndex < length && in[rootIndex] != rootValue)
            rootIndex++;
        ...
        vector<int> preLeft(leftLength), inLeft(leftLength), preRight(rightLength), inRight(rightLength);
